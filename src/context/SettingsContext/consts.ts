 ...
 * worth asking for deliberately rather than inheriting. The zoom mode is a
 * regular user setting, not a developer option, defaulting to 1x since the
 * other modes narrow what the detector can see. What the developer options
 * report while the master switch is off is DEVELOPER_OPTIONS_OFF, not this.
 */
