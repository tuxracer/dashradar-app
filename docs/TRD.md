...
src/
  ...
  components/
    ...
    SettingsScreen/             # full-screen settings panel: audio alerts + detection image + developer option toggles + engine/model/about + share row
