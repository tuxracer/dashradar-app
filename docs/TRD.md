...
src/
  ...
  components/
    ...
    DevVideoView/               # stand-in for CameraView (no onError, camera errors don't exist in this mode): plays whatever DevVideoContext hands back as the detection feed and doubles as a visible, controllable corner player; ships in production, not just dev (§4.3)
