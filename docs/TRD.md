...
`autoSaveFrames`, `throttleInference`, `centerCropFrames`, `zoomMode`, and
...
options, picked from `SettingsScreen`'s segmented Zoom row) selects the crop
