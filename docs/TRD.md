...
| → worker | `detect` | Run one transferred frame, with the cutout flag, zoom, the effective threshold, and the source size when the frame arrives pre-cropped |
