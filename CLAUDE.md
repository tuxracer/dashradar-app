...
- **Raw onnxruntime-web on purpose, never the Transformers.js `pipeline()`.** The head is a 2-wide sigmoid with the real class at index 1, and the pipeline's softmax-with-background DETR decode drops every real detection.
